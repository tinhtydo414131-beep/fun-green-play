...
import { Award, Trophy, Gamepad2, Users, Star, Crown, ExternalLink, Sparkles } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        >
          ...
          <p className="text-muted-foreground">
            Discover all achievement NFTs minted by our community
          </p>
        </motion.div>
                ...
                >
                  <Card className={`overflow-hidden border-2 ${RARITY_BORDER[info.rarity]} hover:shadow-lg transition-all duration-300 hover:-translate-y-1`}>
                    ...
                    <CardContent className="p-4">
                      ...
                      {/* Transaction */}
                      <a
                        href={`https://polygonscan.com/tx/${nft.tx_hash}`}
                        target="_blank"
