...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-br from-primary via-secondary to-primary text-primary-foreground shadow-[0_4px_12px_hsla(262,100%,64%,0.4),0_8px_24px_hsla(186,100%,50%,0.3),inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-3px_10px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_24px_hsla(262,100%,64%,0.6),0_12px_36px_hsla(186,100%,50%,0.5),inset_0_2px_6px_rgba(255,255,255,0.6)] hover:brightness-125 animate-golden-shimmer bg-[length:200%_200%] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-[1500ms] after:absolute after:inset-0 after:bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.8),transparent_50%)] after:opacity-60",
        ...
        outline: "border-2 border-primary-light bg-gradient-to-br from-card via-muted/30 to-card text-foreground shadow-[0_2px_8px_hsla(262,100%,64%,0.2),inset_0_2px_4px_rgba(255,255,255,0.6),inset_0_-2px_8px_rgba(0,0,0,0.15)] hover:border-primary hover:shadow-[0_6px_16px_hsla(262,100%,64%,0.4),inset_0_2px_6px_rgba(255,255,255,0.7)] hover:brightness-110 animate-golden-shimmer bg-[length:200%_200%] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/25 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-[1500ms] after:absolute after:inset-0 after:bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.6),transparent_50%)] after:opacity-50",
        ...
        ghost: "hover:bg-gradient-to-br hover:from-muted/80 hover:via-muted hover:to-muted/60 hover:text-foreground hover:shadow-[inset_0_2px_4px_rgba(255,255,255,0.5)] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/15 before:to-transparent before:translate-x-[-200%] hover:before:translate-x-[200%] before:transition-transform before:duration-[1500ms]",
